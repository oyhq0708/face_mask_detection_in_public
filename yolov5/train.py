...
#TODO: comment out this line to change to swin transformer model
...
#from models.swin_model import Model
...
def parse_opt(known=False):
    ...
    #parser.add_argument('--fl_gamma', type=float, default=1.5, help='focal loss gamma')
